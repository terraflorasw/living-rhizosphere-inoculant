...
While organic composts and vermicomposts contain a diverse variety of beneficial plant microbiota, many beneficial species require an existing root network in order to survive. We want a method to establish beneficial fungal and bacterial species in a living soil bed by utilizing a dense, living root matrix as a pre-activated delivery mechanism.
...
* ***Serendipita indica***: Commercial Agriculture Suppliers & Wholesalers (such as Premier Tech AGTIV IGNITE via Nutrien Ag)

### Inoculation Host Crop

The choice of the plant species used to cultivate the live root matrix must fulfill these baseline requirements:

1. A fibrous and highly branched root architecture,
2. Broad microbial compatibility,
3. High rates of root exudation, and
4. Easy termination

For example, Winter Rye (*Secale cereale*).
...
* **Lighting**: Standard indoor or greenhouse lighting, 16-hour photoperiod
* **Temperature**: Between 15°C and 21°C
* **Irrigation**: Water as needed with plain RO water
* **Duration**: 4 to 6 weeks

## License

This document and the underlying agricultural methodology are dedicated to the public domain under the Creative Commons CC0 1.0 Universal Public Domain Dedication. For details, see [LICENSE](LICENSE)
